        ...
        const getFile = async () => {
            ...
            try{
                const res = await axios.get(
                    apiEnpoints.PUBLIC_FILE_VIEW(fileId)
                );
                setFile(res.data);
                setError(null);
            }
                ...
                setError(
                    "cloud not retrieve file. The link may be invalid or the file may have been removed."
                );
            }
            finally{
                setIsLoading(false);
    ...
    const handleDownload =async () => {
        try{
            const response = await axios.get(
                apiEnpoints.DOWNLOAD_FILES(fileId),
                {
                    responseType: "blob",
                }
            );
        ...
        <div className="bg-gray-50 min-h-screen">
            <header className="p-4 border-b bg-white">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-white"
                    >
                        <Copy size={18}/>
                        Share Link
                    </button>
            ...
            <main className="container mx-auto p-4 md:p-8 flex justify-center">
                <div className="w-full max-w-3xl">
                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8 text-center"> 
                        ...
                        <div className="flex justify-center gap-4 my-8">
                            <button
                                ...
                                className="flex items-center gap-2 px-6 py-6 bg-red-500 text-white rounded-lg"
                            >   
                                <Download size={18}/>
                                Download File
                            </button>
                    ...
                    <div className="mt-6 bg-blue-50 border border-blue   -200 text-blue-600 p-4 rounded-lg">
                        <Info size={20}/>
                        <p className="text-sm"> 
