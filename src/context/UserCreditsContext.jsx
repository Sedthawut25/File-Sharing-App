...
export const UserCreditsProvider = ({children}) => {
    ...
    //Function to fetch the user credits that can be called feom anywhere
    const fetchUserCredits = useCallback(async () =>  {
        ...
        try{
            ...
            const response = await axios.get(apiEnpoints.GET_CREDITS, {headers : {Authorization: `Bearer ${token}`}});
            ...
            console.error('Error fetching thr user credits', error);
        }
        finally{
            setLoading(false);
        }
